...
{
    public class PutExampleContactDetailsRequestValidator : AbstractValidator<PutExampleContactDetailsRequest>
    {
        public PutExampleContactDetailsRequestValidator()
        {
            RuleFor(r => r.Id)
                .NotNull()
    ...
    public class PutExampleContactDetailsRequestAddressObjValidator : AbstractValidator<PutExampleContactDetailsRequest.AddressObj>
    {
        public PutExampleContactDetailsRequestAddressObjValidator()
        {
